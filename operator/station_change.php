...
//   $bus_type= $_SESSION['bus_type'];
    ...
    $op_id=$_SESSION['user_id'];
     $sql154 = $db->query("SELECT route_id FROM bus where bus_id='$bus_id'");
                    
    $row154 = mysqli_fetch_array($sql154);
         $dest4=$row154['route_id'];
  $bus_route=$dest4;
					...
					<div class="container-fluid">
						<div class="navbar-header">
							<div class="navbar-brand">
								<a href="index.html"><h1>Update new details here...</h1></a>
							</div>
						</div>
						<div class="menu">
...
<li role="presentation"><a href="bus_update.php">Update Bus</a></li>
  ...
  <div class="form">
    ...
    <form class="login-form" >
       <label><b>Select New Time Slots </b></label>
 <div class ='td'>
        ...
        <?php
          ...
          <input type="submit" class="button" name="cancel" value="Cancel " />
                ...
                <label><b>Select New Intermediate Stations </b></label>
        <div class ='td'>
           <select name="int" id="int">
            <option value="">Select New Districts</option>
              <?php
        ...
        <?php
          ...
          <input type="submit" class="button" name="cancel1" value="Cancel " />
                ...
                <input type="submit" class="button" name="submit" value="Confirm" onclick="return confirm('Are You Sure to update new details  ?');" />
                  </form>
  </div>
</div>
 <?php
     ...
     if(isset($_GET['submit']) ){
         if(sizeof($_SESSION['time1'])==0 || sizeof($_SESSION['int'])==0){
             echo "<script type='text/javascript'>alert('Select atleast one time or district')</script>";
               ...
               $sql1543 = $db->query("DELETE FROM intermediate_station where bus_id='$bus_id'");
   $sql1544 = $db->query("DELETE FROM bus_timeslot where bus_id='$bus_id'");
//         $query15 = $db->query("INSERT INTO bus (name,total_seats,available_seats,route_id,bus_number,type,operator_id )VALUES( '$bus_name', '$bus_seats','$bus_seats','$bus_route','$bus_number','$bus_type','$op_id' )");
          $sql15 = $db->query("SELECT bus_id FROM bus where bus_id='$bus_id'");
